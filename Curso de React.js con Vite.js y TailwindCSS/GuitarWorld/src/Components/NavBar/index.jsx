...
const Navbar = () => {
  const context = useContext(ShoppinCartContext); // Aqui indico cual sera el contexto que el me va a leer.
  ...
  return (
    <nav className="flex justify-between items-center fixed z-10 top-0 w-full py-5 px-8 text-sm font-light">
      ...
      <ul className="flex items-center gap-3">
        <li className="text-black/60">rainesyahir@outlook.com</li>
        <li>
          <NavLink
            to="/my-orders"
            className={({ isActive }) => (isActive ? activeStyle : undefined)}
